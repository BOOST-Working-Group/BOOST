...
\title{Biomass Open Origin Specification for Tracking (BOOST)}
...
% \w3crepository{https://github.com/BOOST-Working-Group/BOOST}
...
\hypersetup{
    pdftitle={Biomass Open Origin Specification for Tracking (BOOST)},
    pdfauthor={BOOST W3C Community Group},
    pdfsubject={Biomass Open Origin Specification for Tracking},
    pdfkeywords={biomass, traceability, W3C, data specification, supply chain, LCFS, certification},
...
\fancyhead[R]{\small v3.4.2-49-g299b4d3}
...
\begin{w3cstatus}
This report was published by the Biomass Open Origin Specification for Tracking (BOOST) Community Group (\url{https://www.w3.org/community/boost-01/}). It is not a W3C Standard nor is it on the W3C Standards Track. Please note that under the W3C Community Contributor License Agreement (CLA) (\url{https://www.w3.org/community/about/agreements/cla/}) there is a limited opt-out and other conditions apply. Learn more about W3C Community and Business Groups at \url{https://www.w3.org/community/}.

Copyright \copyright{} 2025-2026 the Contributors to the Biomass Open Origin Specification for Tracking (BOOST) Specification, published by the Biomass Open Origin Specification for Tracking (BOOST) Community Group under the W3C Community Contributor License Agreement (CLA). A human-readable summary is available at \url{https://www.w3.org/community/about/agreements/cla-deed/}.
...
This specification is primarily developed on GitHub (\url{https://github.com/BOOST-Working-Group/BOOST}). The best way to contribute to this specification is to:

\begin{enumerate}
    \item File issues and suggestions in the BOOST GitHub repository (\url{https://github.com/BOOST-Working-Group/BOOST/issues})
    \item Submit pull requests for specific changes
    \item Participate in community discussions via GitHub Discussions (\url{https://github.com/BOOST-Working-Group/BOOST/discussions})
...
This specification defines the BOOST (Biomass Open Origin Specification for Tracking) data model for biomass supply chain tracking and verification. The specification provides:
...
\input{tex/core-traceability-entities}
\input{tex/organizational-foundation-entities}
\input{tex/material-and-supply-chain-entities}
\input{tex/transaction-management-entities}
\input{tex/measurement-and-verification-entities}
\input{tex/geographic-and-tracking-entities}
\input{tex/compliance-and-reporting-entities}

% Chapter 7: Plant Part Categorization System  
\section{Plant Part Categorization System}
\label{sec:plant-parts}
\input{tex/plant-parts}
...
\input{tex/lcfs-programmatic-reporting}

% Chapter 12: Security Considerations
\section{Security Considerations}
\label{sec:security}
\input{tex/security-considerations}
...
\url{https://github.com/BOOST-Working-Group/BOOST/tree/main/references}
...
\begin{itemize}
    \item \textbf{Claude (Anthropic)} - AI-assisted development including schema integrity validation, Python reference implementation enhancements, comprehensive documentation generation, expert review integration, and systematic issue resolution supporting v3.4.2-49-g299b4d3 release preparation
\end{itemize}
