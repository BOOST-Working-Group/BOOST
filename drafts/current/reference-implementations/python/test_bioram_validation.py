...
def test_bioram_pathway_validation():
    ...
    valid_pathway = {
        '@context': {'boost': 'https://github.com/Biogenics-Traceability/BOOST/contexts/'},
        '@type': 'BioramPathway',
        '@type': 'BioramPathway',
                '@id': 'https://github.com/Biogenics-Traceability/BOOST/schemas/bioram-pathway/BIORAM-PWR-2025-LMR-001',
...
def test_bioram_reporting_validation():
    ...
    valid_report = {
        ...
        '@type': 'BioramReporting',
                '@id': 'https://github.com/Biogenics-Traceability/BOOST/schemas/bioram-reporting/BIORAM-RPT-2025-Q3-SHWD001',
...
def test_bioram_transaction_validation():
    ...
    valid_transaction = {
        '@context': {'boost': 'https://github.com/Biogenics-Traceability/BOOST/contexts/'},
        '@type': 'Transaction',
                '@id': 'https://github.com/Biogenics-Traceability/BOOST/schemas/transaction/TXN-BIORAM-001',
...
def test_bioram_organization_validation():
    ...
    valid_organization = {
        '@context': {'boost': 'https://github.com/Biogenics-Traceability/BOOST/contexts/'},
        '@type': 'Organization',
                '@id': 'https://github.com/Biogenics-Traceability/BOOST/schemas/organization/ORG-SHERWOOD-POWER-001',
