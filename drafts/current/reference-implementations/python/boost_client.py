...
class BOOSTClient:
    ...
    def __init__(self, context_url: Optional[str] = None, schema_path: Optional[str] = None):
        ...
        """
        self.context_url = context_url or "https://github.com/Biogenics-Traceability/BOOST/context"
        ...
        self.default_context = {
            "@context": {
                "boost": "https://github.com/Biogenics-Traceability/BOOST/schemas#",
    ...
    def create_organization(
        ...
        **kwargs
        ...
        org_data = {
            ...
            "@type": "Organization",
            "@id": f"https://github.com/Biogenics-Traceability/BOOST/schemas/organization/{organization_id}",
    ...
    def create_traceable_unit(
        ...
        **kwargs
        ...
        tru_data = {
            "@context": self.default_context["@context"],
            "@type": "TraceableUnit", 
            "@id": f"https://github.com/Biogenics-Traceability/BOOST/schemas/traceable-unit/{traceable_unit_id}",
    ...
    def create_transaction(
        ...
        **kwargs
        ...
        transaction_data = {
            "@context": self.default_context["@context"],
            "@type": "Transaction",
            "@id": f"https://github.com/Biogenics-Traceability/BOOST/schemas/transaction/{transaction_id}",
    ...
    def create_material_processing(
        ...
        **kwargs
        ...
        processing_data = {
            ...
            "@id": f"https://github.com/Biogenics-Traceability/BOOST/schemas/processing/{processing_id}",
    ...
    def create_claim(
        ...
        **kwargs
        ...
        claim_data = {
            "@context": self.default_context["@context"],
            "@type": "Claim",
            "@id": f"https://github.com/Biogenics-Traceability/BOOST/schemas/claim/{claim_id}",
            "claimId": claim_id,
            "traceableUnitId": traceable_unit_id,
    ...
    def create_tracking_point(
        ...
        **kwargs
        ...
        tracking_point_data = {
            "@context": self.default_context["@context"],
            "@type": "TrackingPoint",
            "@id": f"https://github.com/Biogenics-Traceability/BOOST/schemas/tracking-point/{tracking_point_id}",
