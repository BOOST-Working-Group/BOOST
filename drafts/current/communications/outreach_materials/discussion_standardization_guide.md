...
- **ERD Navigator**: [View in full context →](https://biogenics-traceability.github.io/BOOST/erd-navigator/)
...
1. Go to the specific discussion URL (GitHub.com/Biogenics-Traceability/BOOST/discussions/[number])
