...
### Key Features
- **🐳 Docker Containerization**: All builds use `ghcr.io/biogenics-traceability/boost/boost-builder:latest` for 4-6x faster execution
...
**Container**: `ghcr.io/biogenics-traceability/boost/boost-builder:latest`
...
3. **GitHub Pages Deployment**: Publishes to `biogenics-traceability.github.io/BOOST`
...
- Live website at https://biogenics-traceability.github.io/BOOST
...
- **GitHub Container Registry**: Publishes to `ghcr.io/biogenics-traceability/boost/boost-builder`
...
jobs:
  build:
    ...
    container:
      image: ghcr.io/biogenics-traceability/boost/boost-builder:latest
...
git clone https://github.com/Biogenics-Traceability/BOOST.git
...
docker pull ghcr.io/biogenics-traceability/boost/boost-builder:latest

# Run interactive container
docker run -it --rm -v $(pwd):/workspace ghcr.io/biogenics-traceability/boost/boost-builder:latest
