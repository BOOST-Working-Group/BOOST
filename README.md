...
[![Build & Deploy Documentation](https://github.com/Biogenics-Traceability/BOOST/workflows/🚀%20Build%20&%20Deploy%20Documentation/badge.svg)](https://github.com/Biogenics-Traceability/BOOST/actions/workflows/build-deploy.yml)
[![Schema Validation](https://github.com/Biogenics-Traceability/BOOST/workflows/🔍%20Schema%20Validation/badge.svg)](https://github.com/Biogenics-Traceability/BOOST/actions/workflows/schema-validation.yml)
[![PR Validation](https://github.com/Biogenics-Traceability/BOOST/workflows/📋%20PR%20Validation/badge.svg)](https://github.com/Biogenics-Traceability/BOOST/actions/workflows/validate-pr.yml)
[![Development Docs](https://github.com/Biogenics-Traceability/BOOST/workflows/📚%20Build%20Development%20Documentation/badge.svg)](https://github.com/Biogenics-Traceability/BOOST/actions/workflows/build-dev-docs.yml)
...
Feedback and contributions are welcomed via GitHub Issues and Pull Requests at [BOOST](https://github.com/Biogenics-Traceability/BOOST).
...
- **[📄 Complete PDF Specification](https://Biogenics-Traceability.github.io/BOOST/boost-spec.pdf)** - 88+ page comprehensive specification with all 36 entities
- **[🌐 Interactive HTML Specification](https://Biogenics-Traceability.github.io/BOOST/boost-spec.html)** - W3C-compliant browsable documentation
- **[📊 Interactive ERD Navigator](https://Biogenics-Traceability.github.io/BOOST/erd-navigator/)** - Visual exploration of entity relationships and data model
- **[🗂️ JSON Schema Repository](https://github.com/Biogenics-Traceability/BOOST/tree/main/drafts/current/schema)** - 36 validation schemas (single source of truth)

### **Development Resources**
- **[📈 Build and Consistency Reports](https://github.com/Biogenics-Traceability/BOOST/tree/main/drafts/current/specifications/build)** - Automated validation and generation statistics
- **[📝 Complete Version History](https://github.com/Biogenics-Traceability/BOOST/blob/main/CHANGELOG.md)** - Detailed change documentation
- **[✅ Enhancement Planning](https://github.com/Biogenics-Traceability/BOOST/issues?q=label%3Aplan)** - GitHub Issues-based project planning with stakeholder collaboration

## 🚀 Recent Changes & Improvements

### **Latest Updates (v3.4.2)**
- **📋 Enhanced Collaboration**: Migrated all enhancement plans to GitHub Issues ([#259](https://github.com/Biogenics-Traceability/BOOST/issues/259)-[#262](https://github.com/Biogenics-Traceability/BOOST/issues/262)) for improved stakeholder engagement and transparency
...
**Access**: Visit the [Live Interactive ERD Navigator](https://Biogenics-Traceability.github.io/BOOST/erd-navigator/) or use the local version at `erd-navigator/index.html`
...
# - https://Biogenics-Traceability.github.io/BOOST/
# - Interactive ERD Navigator
# - Schema file access
```
